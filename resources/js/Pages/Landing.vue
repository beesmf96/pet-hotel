...
<template>
    <div class="min-h-screen bg-cream text-ink font-sans">
        ...
        <section class="relative overflow-hidden px-5 pt-14 pb-10 sm:px-10 sm:pt-20">
            <div
                class="hidden lg:block absolute left-24 top-24 w-28 h-28 rounded-full bg-coral"
                aria-hidden="true"
            ></div>
            <div
                class="hidden lg:block absolute right-28 top-14 w-20 h-20 rounded-3xl bg-teal rotate-12"
                aria-hidden="true"
            ></div>
            <div
                class="hidden lg:block absolute right-64 top-72 w-14 h-14 rounded-full bg-mustard border-3 border-ink"
                aria-hidden="true"
            ></div>
            ...
            <div class="relative max-w-5xl mx-auto flex flex-col items-center text-center gap-6">
                ...
                <p class="text-lg sm:text-xl text-moss max-w-xl" style="text-wrap: pretty">
                    Find a boarding hotel your pet will actually enjoy. Real photos, real reviews, instant booking
                    requests.
                </p>
            </div>

            <div class="relative max-w-5xl mx-auto mt-10 card-hard-lg p-4 sm:p-5">
        ...
        <section v-if="hasFeatured" class="px-5 py-16 sm:px-10 sm:py-20">
            <div class="max-w-7xl mx-auto">
                <div class="flex items-end justify-between gap-4 mb-8">
                    ...
                    <UiButton as="a" variant="white" size="sm" class="whitespace-nowrap" href="/hotels"
                        >All hotels</UiButton
                    >
                </div>
        ...
        <section class="px-5 pb-20 sm:px-10 sm:pb-24">
            <div class="max-w-2xl mx-auto flex flex-col items-center text-center gap-5">
                ...
                <UiButton as="a" variant="mustard" size="lg" :href="user ? '/owner' : '/register'"
                    >List your hotel</UiButton
                >
            </div>
        </section>
